...
const Humbermenu=({setMenu})=>{
    ...
    return(
        ...
        <div className="fixed top-0 z-10 bg-white right-0 h-screen w-full">
           <span className="flex justify-end pt-5 pr-4">
            <Image  width={30}
        height={30} alt="vaishnavi logo" className="h-4 mt-5 pr-5" onClick={()=>setMenu(false)} src="https://www.vaishnavigroup.com/wp-content/uploads/2021/09/close.svg" />
            </span>
