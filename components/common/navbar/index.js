...
<div className={scroll?'container flex justify-between fixed bg-[#5b6664]  top-0 text-white ':'container flex justify-between text-[#1F1D5E]'}>
    <div className="logo">
        <img className=" h-20 sm:h-24" src={scroll?'https://www.vaishnavigroup.com/wp-content/uploads/2019/10/vaishnavi-logofinal.svg':'https://www.vaishnavigroup.com/wp-content/uploads/2022/02/logo.svg'} />
    </div>
