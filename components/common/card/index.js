...
<div className="rounded-md border border-gray-300 shadow-sm">
   <Image alt={portfolio.projectTitle}  width={100}
        height={70}  layout="responsive" className="rounded-t-md   object-cover h-72  w-full" src={portfolio.projectImage} />
   <div className="p-5">
    ...
    {portfolio.type && (<div className="grid grid-cols-4 mt-2"><p className="col-span-1">Type</p> <p className="col-span-3">{portfolio.type}</p></div>)}
    {portfolio.rera && ( <div  className="grid grid-cols-4 mt-2 "><p  className="col-span-1"> RERA</p><p  className="col-span-3">{portfolio.rera}</p> </div>)}
   </div>
</div>
    );
